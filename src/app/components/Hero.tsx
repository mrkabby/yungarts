    ...
    <section className="h-screen flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 bg-gray-100 dark:bg-gray-900 relative text-center md:text-left">
      <div className="max-w-lg">
        ...
        <p className="mt-4 md:mt-6 text-gray-600 dark:text-gray-300 text-lg max-w-md">
          I'm a graphics designer who loves to create beautiful and functional
          designs.
        </p>
        <p className="mt-2 text-gray-600 dark:text-gray-300 text-lg max-w-md">
          I’m a passionate Graphic Designer dedicated to crafting visually
          compelling and meaningful designs. With a keen eye for aesthetics and
          a love for creativity, I specialize in branding, digital
          illustrations, and user-friendly designs that leave a lasting impact.
          My goal is to bring ideas to life through thoughtful composition,
          color, and typography.
        </p>
        <div className="flex gap-6 mt-6 justify-center md:justify-start">
          <a
            href="#"
            className="text-3xl md:text-4xl text-purple-500 hover:text-purple-700"
          >
            <FaFacebook />
          </a>
          <a
